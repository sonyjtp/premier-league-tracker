...
class Match(Base):
    ...
    advanced_stats = relationship("MatchAdvancedStats", back_populates="match", uselist=False)

    __table_args__ = (
        UniqueConstraint("season_id", "match_date", "home_team_id", "away_team_id", name="uq_match_unique"),
...
class GameweekStanding(Base):
    ...
    __table_args__ = (
        UniqueConstraint("competition_id", "season_id", "team_id", "gameweek", name="uq_gw_standing"),
...
class PlayerSeasonSummary(Base):
    ...
    __table_args__ = (
        UniqueConstraint("player_id", "season_id", "competition_id", name="uq_player_season_comp"),
    )
...
class MatchEvent(Base):
    ...
    __table_args__ = (
        UniqueConstraint(
            "fixture_api_id", "minute", "event_type", "player_name",
            name="uq_match_event",
        ),
    )
...
class MatchLineup(Base):
    ...
    __table_args__ = (
        UniqueConstraint("fixture_api_id", "team_name", "player_name", name="uq_lineup_entry"),
    )
